  ...
  return (
    <div>
      <h2 id="school-heading">
        <Translate contentKey="helloMhipsterApp.school.home.title">Schools</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="helloMhipsterApp.school.home.createLabel">Create new School</Translate>
        </Link>
      </h2>
        ...
        {schoolList && schoolList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="helloMhipsterApp.school.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="helloMhipsterApp.school.home.notFound">No Schools found</Translate>
            </div>
          )
        )}
      </div>
