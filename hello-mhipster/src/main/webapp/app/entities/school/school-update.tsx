  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="helloMhipsterApp.school.home.createOrEditLabel">
            <Translate contentKey="helloMhipsterApp.school.home.createOrEditLabel">Create or edit a School</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
