...
export const SchoolDeleteDialog = (props: ISchoolDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="helloMhipsterApp.school.delete.question">
        <Translate contentKey="helloMhipsterApp.school.delete.question" interpolate={{ id: schoolEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-school" color="danger" onClick={confirmDelete}>
