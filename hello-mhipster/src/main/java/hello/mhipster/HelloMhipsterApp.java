package hello.mhipster;

import hello.mhipster.config.DefaultProfileUtil;
...
@OpenAPIDefinition(
    info = @Info(
        title = "HelloMhipster",
        version = "0.0",
        description = "HelloMhipster API"
    )
)
public class HelloMhipsterApp {

    private static final Logger log = LoggerFactory.getLogger(HelloMhipsterApp.class);

    /**
     * Initializes HelloMhipsterApp.
     * <p>
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = Micronaut.build(args)
            .mainClass(HelloMhipsterApp.class)
