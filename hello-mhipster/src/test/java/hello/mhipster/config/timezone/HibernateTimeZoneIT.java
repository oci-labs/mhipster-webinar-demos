package hello.mhipster.config.timezone;

import hello.mhipster.HelloMhipsterApp;
import hello.mhipster.repository.timezone.DateTimeWrapper;
import hello.mhipster.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@MicronautTest(application = HelloMhipsterApp.class, environments = {"test"})
