package com.mhipster.demo.invoice.config.timezone;

import com.mhipster.demo.invoice.InvoiceApp;
import com.mhipster.demo.invoice.repository.timezone.DateTimeWrapper;
import com.mhipster.demo.invoice.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@MicronautTest(application = InvoiceApp.class, environments = {"test"})
