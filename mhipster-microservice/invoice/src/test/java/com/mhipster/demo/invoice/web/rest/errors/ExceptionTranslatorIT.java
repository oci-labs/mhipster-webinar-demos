package com.mhipster.demo.invoice.web.rest.errors;

import com.mhipster.demo.invoice.InvoiceApp;
import com.mhipster.demo.invoice.web.rest.errors.handlers.ProblemHandler;
 ...
 */
@MicronautTest(application = InvoiceApp.class)
