package com.mhipster.demo.store.gateway.responserewriting;
...
import static com.mhipster.demo.store.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
