package com.mhipster.demo.crm.web.rest.errors;

import com.mhipster.demo.crm.CrmApp;
import com.mhipster.demo.crm.web.rest.errors.handlers.ProblemHandler;
 ...
 */
@MicronautTest(application = CrmApp.class)
